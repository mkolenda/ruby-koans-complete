...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Inject uses each element in an array in a block.  After each element is evaluated by the block
    # inject passes the result of the evaluation to the block for use when the next element is evaluated.
    # inject returns the last value of the block
  end
